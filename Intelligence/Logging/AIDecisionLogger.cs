...
namespace BanditMilitias.Intelligence.Logging
{
    ...
    public static class AIDecisionLogger
    {
        ...
        private static readonly string LogPath = Path.Combine(LogDirectory, "AIDecisions.log");
        private static readonly string ArchivePath = Path.Combine(LogDirectory, "AIDecisions_prev.log");
            ...
            Dictionary<string, float> allScores)
        {
            ...
            _ = sb.AppendLine();
            _ = sb.Append($"  Personality={personality} | Gold={gold:F0}");
            _ = sb.AppendLine();
            ...
            int warlordCount)
        {
            ...
            Write($"[DAILY] Decisions={totalDecisions} | Commands={totalCommands} | " +
                  $"SuccessRate={overallSuccessRate:P0} | AvgConfidence={avgConfidence:F2} | Warlords={warlordCount}");
        }
