...
namespace BanditMilitias.Intelligence.Swarm
{
    ...
    public class SwarmCoordinator : MilitiaModuleBase
    {
        ...
        private void DetectAndFormGroups()
        {
            ...
            // Paging: Her saat sadece en eski 15 gruplanmamış birimi işlemden (Gather) geçir.
            // Bu O(N^2) patlamasını dağıtır.
            ...
            foreach (var seed in seedsToProcess)
            {
                ...
                var cluster = GatherCluster(seed, ungrouped, visited, COORDINATION_RADIUS);
            ...
            float radius)
        {
            ...
            while (queue.Count > 0)
            {
                ...
                // Spatial Locator (Grid System) kullanımı ile O(N^2)'den O(1) grid aramasına geçiş
                ...
                foreach (var candidate in nearby)
                {
                    ...
                    if (!candidates.Contains(candidate)) continue; // Emin olmak için
