...
namespace BanditMilitias.Systems.Diplomacy
{
    ...
    public class BanditPoliticsSystem : MilitiaModuleBase
    {
        ...
        private void EvaluatePoliticalLandscape(IReadOnlyList<Warlord> warlords)
        {
            if (warlords.Count < 2)
                return;
        ...
        private void FormAlliance(Warlord first, Warlord second, WarlordPoliticalRelation relation)
        {
            ...
            {
                DebugLogger.Warning("BanditPolitics", $"Failed to display alliance message: {ex.Message}");
            }
        ...
        private void DeclareRivalry(Warlord first, Warlord second, WarlordPoliticalRelation relation)
        {
            ...
            {
                DebugLogger.Warning("BanditPolitics", $"Failed to display rivalry message: {ex.Message}");
            }
        ...
        private void OnHideoutCleared(HideoutClearedEvent evt)
        {
            ...
            lock (_stateLock)
            {
                EnsureProfilesAndRelations(WarlordSystem.Instance.GetAllWarlords());
            }
        }
        ...
        private void EnsureProfilesAndRelations(IReadOnlyList<Warlord> aliveWarlords)
        {
