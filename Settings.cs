...
namespace BanditMilitias
{
    ...
    public class Settings : AttributeGlobalSettings<Settings>
    {
        ...
        [SettingPropertyBool("{=BMS_NeuralAI}Enable Neural AI (Dev Only)", Order = 5, RequireRestart = false,
            HintText = "{=BMS_NeuralAI_H}EXPERIMENTAL: Enables the custom hand-written neural network advisor. Parallel to heuristics. Default: OFF.")]
        [SettingPropertyGroup("{=BMSG_Debug}8. Technical & Debug")]
        ...
        [SettingPropertyGroup("{=BMSG_AdvTech}8. Technical & Debug/Advanced Technical")]
        public bool EnableAIDecisionLogging { get; set; } = true;
